        ...
        <Col sm={9} md={10} className="content position-relative min-vh-100 d-flex flex-column">
          ...
          <Row className='flex-grow-1'>
            <Col className='me-1 dashcontentcol h-100 px-3 pt-4'>
              <Row className='p-3'>
                <Col xs={10}>
                  <p className='servcancelled my-auto'>Cancelled</p>
                </Col>
                <Col xs={2} className='pe-4'>
                  <Button variant="primary" className='servcancelledbtn float-end w-75 my-auto'>Back</Button>
                </Col>
              </Row>
              <Row className='p-3'>
                <Col>
                  <Button variant="primary" className='servcancelledlistbtn d-block mb-3'>0002-1856C</Button>
                  <Button variant="primary" className='servcancelledlistbtn d-block mb-3'>0001-1856C</Button>
                </Col>
              </Row>
            </Col>
          </Row>
