...
const DoubleDeckBedroom = ({ data }) => {
    const rightArrowIcon = {
        backgroundImage: 'url("https://api.iconify.design/ic/round-keyboard-arrow-right.svg?width=18&height=18")',
        width: '18px',
        height: '18px',
        ...
        <SimpleLayout>
            <section>
                <Container className='py-5 montserratmedium breadcrumb px-3'>
                    <Breadcrumb>
                        ...
                        <Breadcrumb.Item as={Link} to='/services/double-deck-bedroom'>Double Deck Bed</Breadcrumb.Item>
            ...
            <section>
                <Container>
                    <Row>
                        <Col md={6}>
                            <p className="d-inline-block lh-1 tradeext fw-bold fs-2 pe-3">Double Deck Bedroom</p>
                    ...
                    <Row>
                        <Col md={6} className="p-1">
                            <StaticImage
                                src="../../images/website/doubleimg1.png"
                                alt=""
                                className="img-fluid"
                            />
                        </Col>
                        <Col md={6}>
                            <Row>
                                ...
                                <Col className="p-1" md={6}>
                                    <StaticImage
                                        src="../../images/website/doubleimg3.png"
                                        alt=""
                                        className="img-fluid"
                                    />
                                </Col>
                            ...
                            <Row>
                                ...
                                <Col className="p-1 position-relative" md={6}>
                                    ...
                                    {/* Modal */}
                                    <div className="modal fade" id="targetModal" tabIndex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
                                        <div className="modal-dialog modal-dialog-centered">
                                            <div className="modal-content">
                                                <div className="modal-header">
                                                    <h1 className="modal-title fs-5" id="ModalLabel">Photo Gallery</h1>
                                                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div className="modal-body">
                                                    <div id="carouselImageIndicators" className="carousel slide" data-mdb-ride="carousel">
                                                        <div className="carousel-indicators">
                                                            <button type="button" data-mdb-target="#carouselImageIndicators" data-mdb-slide-to="0" className="active" aria-current="true" aria-label="Slide 1"></button>
                                                            <button type="button" data-mdb-target="#carouselImageIndicators" data-mdb-slide-to="1" aria-label="Slide 2"></button>
                                                            <button type="button" data-mdb-target="#carouselImageIndicators" data-mdb-slide-to="2" aria-label="Slide 3"></button>
                                                            <button type="button" data-mdb-target="#carouselImageIndicators" data-mdb-slide-to="3" aria-label="Slide 4"></button>
                                                        </div>
                    ...
                    <Row>
                        <Col>
                            <ul className="montserratmedium fs-5 py-5">
                                ...
                                <li>Can cook (Kitchen area located on the ground floor, free use of kitchen utensils)</li>
                    ...
                    <Row>
                        ...
                        <Col md={6} className="d-flex align-items-center justify-content-end">
                            <small className="montserratmedium fw-bold">
                                <a href="https://goo.gl/maps/fmYGpbsHeCSK5CMA7">View on Google Maps</a>
                            </small>
                        </Col>
                    </Row>
                    <Row>
...
export default DoubleDeckBedroom